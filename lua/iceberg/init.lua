...
local function set_hl_groups()
    local groups = {
        ...
        Title = { fg = "#e2a478" },
        Todo = { bg = "#45493e", fg = "#b4be82", bold = false },
        Type = { fg = "#84a0c6" },
        ...
        MasonHighlightBlockBold = { bg = "#89b8c2", fg = "#0f1117", bold = false },
        MasonHighlightSecondary = { fg = "#b4be82" },
        MasonHighlightBlockSecondary = { bg = "#b4be82", fg = "#0f1117" },
        MasonHighlightBlockBoldSecondary = { bg = "#b4be82", fg = "#0f1117", bold = false },
        MasonMuted = { fg = "#6b7089", },
        MasonMutedBlock = { bg = "#6b7089", fg = "#0f1117" },
        MasonMutedBlockBold = { bg = "#6b7089", fg = "#0f1117", bold = false },
        MasonError = { fg = "#e27878" },

        LeapMatch = { bg = "#e2a478", fg = "#1e2132", bold = false },
        LeapLabelPrimary = { bg = "#b4be82", fg = "#1e2132", bold = false },
        LeapLabelSecondary = { bg = "#a093c7", fg = "#1e2132", bold = false },
